...
export default function SqlEditorPage() {
  ...
  const renderOutput = () => {
    if (error) {
      return (
        <Alert variant="destructive" className="mt-2 border-red-500 bg-red-50 dark:bg-red-950">
          <AlertTitle className="flex items-center gap-2 text-red-600 dark:text-red-400">
            <AlertTriangle size={18} /> Error
          </AlertTitle>
          <AlertDescription className="text-sm">{error}</AlertDescription>
          <AlertDescription className="text-sm mt-1">
            Execution Time: <span className="text-red-600 dark:text-red-400">{executionTime} s</span>
          </AlertDescription>
        </Alert>
      );
    }
      ...
      if (rows.length === 0) {
        return (
          <Alert variant="default" className="mt-2 border-blue-500 bg-blue-50 dark:bg-blue-950">
            ...
            <AlertDescription className="text-sm mt-1">
              Execution Time: <span className="text-blue-600 dark:text-blue-400">{executionTime} s</span>
            </AlertDescription>
          </Alert>
        );
      }
    ...
    return (
      ...
      >
        ...
        <AlertDescription className="text-sm mt-1">
          Execution Time: <span className="text-green-600 dark:text-green-400">{executionTime} s</span>
        </AlertDescription>
      </Alert>
    );
  };
